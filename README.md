...
<p align="center">
  <a href="https://github.com/abhinayakuchi-source">
    <img src="https://img.shields.io/badge/GitHub-Abhinaya%20Kuchi-181717?style=for-the-badge&logo=github&logoColor=white"/>
  </a>
  <a href="https://www.linkedin.com/in/abhinaya-kuchi-b5823b337">
    <img src="https://img.shields.io/badge/LinkedIn-Abhinaya%20Kuchi-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a>
</p>
...
**Technologies:** `Python` `Pandas` `Data Analysis` `Visualization` `Forecasting`
...
**Technologies:** `Node.js` `Express.js` `MongoDB` `Mongoose` `Cron` `Nodemailer`
...
### 📊 DATA ANALYTICS
`Data Cleaning` `EDA` `Data Visualization` `Statistical Analysis` `Business Analytics`

### 🤖 MACHINE LEARNING
`Classification` `Regression` `Predictive Modeling` `Feature Engineering` `Model Evaluation`

### 🧠 DEEP LEARNING
`Neural Networks` `CNN` `Image Classification` `Computer Vision`

### 💻 APPLICATION DEVELOPMENT
`Python` `Flask` `Streamlit` `HTML` `CSS` `JavaScript` `Database Applications`
...
Internship experience focused on developing technical and software development skills.
